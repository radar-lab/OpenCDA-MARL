# OpenCDA Core Components

!!! info "Complete Documentation"
    For comprehensive OpenCDA documentation, please visit the [Official OpenCDA Documentation](https://opencda-documentation.readthedocs.io/en/latest/).
...
[:fontawesome-brands-github: OpenCDA 0.1.3](https://github.com/ucla-mobility/OpenCDA){ .md-button .md-button--primary }
