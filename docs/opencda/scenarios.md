...
│   │   ├── evaluations # evaluation scripts for different modules' performance
...
As the figure above depicts, to run simulation testings in OpenCDA, there are five general steps:
...
Next, the traffic flow is produced. Check [CARLA Traffic Generation](traffic_generation.md#carla-traffic-manager) to see more details about CARLA traffic generation.
